...
>
> **实验脚本**: [`src/run_raid.py`](../src/run_raid.py)（方法对比） | [`src/run_raid_analysis.py`](../src/run_raid_analysis.py)（深度分析）
>
> **父项目**: [README.md](../README.md) — 完整的多数据集 AI 文本检测研究
...
![Attack feature shift](../figures/raid_attack_feature_shift.png)
