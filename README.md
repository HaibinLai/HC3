...
>
> **30 维 Token 特征详解：** [reports/token_features_detailed.md](reports/token_features_detailed.md) — 每个特征的定义、公式、直觉和跨数据集 SHAP 分析
...
| 数据集 | XGBoost (90特征) | RoBERTa | Fast-DetectGPT | Mistral-7B CE | Token (Mistral-7B) | Token (Qwen3.5-4B) | Token (Qwen3.6-35B) |
|--------|:-:|:-:|:-:|:-:|:-:|:-:|:-:|
| HC3 | **0.9999** | 0.9980 | 0.9292 | 0.9933 | 0.9998 | 0.9994 | 0.9995 |
